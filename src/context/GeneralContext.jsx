...
const GeneralContextProvider = ({children}) => {
    ...
    useEffect(() => { 
      ...
      const fetchTopNews = async () => {
        try {
          const response = await axios.get("https://newsapi.org/v2/everything?q=popular&apiKey=73f9aa06b3894f64acafcd178e19acba");
      ...
      const fetchBusinessNews = async () => {
        try {
          const response = await axios.get("https://newsapi.org/v2/everything?q=business&apiKey=73f9aa06b3894f64acafcd178e19acba");
      ...
      const fetchTechnologyNews = async () => {
        try {
          const response = await axios.get("https://newsapi.org/v2/everything?q=technology&apiKey=73f9aa06b3894f64acafcd178e19acba");
